"""
Test EncoderDecoderAction + ActionHead using the Cityscapes config file.
Loads the config, builds the model, loads a sample from the Cityscapes dataset,
